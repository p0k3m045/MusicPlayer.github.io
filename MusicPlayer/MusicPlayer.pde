...
float skipfifteenDivX, skipfifteenDivY, skipfifteenDivWidth, skipfifteenDivHeight, nextsongDivX, nextsongDivY, nextsongDivWidth, nextsongDivHeight;
...
void draw() {
  ...
  float playSymbolDivX1 = playDivX + looponceDivWidth*1/4;
  float playSymbolDivY1 = playDivY +  looponceDivHeight*1/4;
  float playSymbolDivX2 = playDivX + looponceDivWidth*3/4;
  float playSymbolDivY2 = playDivY +  looponceDivHeight*1/2;
  float playSymbolDivX3 = playDivX + looponceDivWidth*1/4;
  float playSymbolDivY3 = playDivY +  looponceDivHeight*3/4;
  //
  /*
